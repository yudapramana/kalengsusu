                                    ...
                                    <div class="col-12">
                                        ...
                                        <form action="{{ route('posts.store') }}" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <textarea name="desc" id="desc" cols="50" rows="200" class="form-control @error('desc') is-invalid @enderror">{{ htmlspecialchars(old('desc')) }}</textarea>
                                                @error('desc')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                            ...
                                            <div class="form-group mb-3 row">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="text" name="photographer" class="form-control @error('photographer') is-invalid @enderror" value="{{ old('photographer') }}" placeholder="Nama Fotografer">
                                                    @error('photographer')
                                                        <div class="invalid-feedback">
                                                            {{ $message }}
                                                        </div>
...
//    <script>
//        var konten = document.getElementById("desc_");

...
<div class="modal fade show" id="tambahGroup" tabindex="-1" aria-modal="true" role="dialog" style="display: block;">
...
<!-- Tambah Group -->
<!-- <div class="modal fade" id="tambahGroup" tabindex="-1" role="dialog"
     aria-labelledby="tambahGroupLabel" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
  <div class="modal-dialog modal-fullscreen" role="document">
        <form id="groupForm" method="post" action="/blog/posts" enctype="multipart/form-data">
            {{ csrf_field() }}
            <div class="modal-content">
                <div class="modal-header">

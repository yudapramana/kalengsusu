            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 mb-4 mb-lg-0 animation" data-animation="fadeInUp" data-animation-delay="0.1s">
                    <div class="footer_logo">
                        <a href="index-9.html"><img alt="logo" src="{{ asset('assets/images/logo/kanwil_logo_white.png') }}"></a>
                    </div>
                ...
                <div class="col-lg-3 col-md-6 mb-4 mb-lg-0 animation" data-animation="fadeInUp" data-animation-delay="0.2s">
                    ...
                    <ul class="list_none widget_links">
                        ...
                        <li style="padding: 0; !important"><a href="{{ config('isec.base_url') }}/controlcenter/login">Login</a></li>
                    </ul>

                    <h6 class="widget_title mt-3 mb-1">STATISTIK KUNJUNGAN</h6>
                    <ul class="list_none widget_links">
                        <li style="padding: 0; !important"><a>Hari ini: {{ $daily }}</a></li>
                        <li style="padding: 0; !important"><a>Bulan ini: {{ $monthly }}</a></li>
                        <li style="padding: 0; !important"><a>Tahun ini: {{ $yearly }}</a></li>
                    </ul>
                </div>
